...
/**
 * ckit_memory_write - Write to session memory.
 */
...
const definition = {
  name: 'ckit_memory_write',
  description: 'Write to ckit session memory (docs/.ckit-memory.json). Persists across sessions.',
  inputSchema: {
    type: 'object',
    properties: {
      key: {
