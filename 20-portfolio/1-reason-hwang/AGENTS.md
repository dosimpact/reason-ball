...
- 변경 사항을 계획, 구현 또는 검토하기 전에 [문서 맵](docs/README.md)을 읽어보세요. 패키지 소유권, 명령어, 포트, 아키텍처, 코딩 규칙 및 유효성 검사 정책으로 안내합니다. 이러한 세부 정보를 여기에 중복해서 작성하지 말고 해당 원본(canonical) 문서에 유지하세요.
...
- 코드 구현을 완료합니다. 코드 구현 원칙에 대해서는 변경 사항을 계획, 구현 또는 검토하기 전에 [문서 맵](docs/README.md)을 읽어보세요.


Phase - 유효성 검사 (Validation)

- [검증 원칙](docs/validation/README.md)을 읽고 변경 유형별 필수 검증을 모두 수행하세요.
...
Phase - 문서화  
- [문서 맵](docs/README.md)을 읽고 적절한 위치에 변경사항을 기록합니다.   
