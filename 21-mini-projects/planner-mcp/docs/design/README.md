...
무엇이 왜 바뀌었는지는 [변경 이력](../changes/README.md)에 별도로 기록합니다.

| 문서 | 목적 | 상태 |
| --- | --- | --- |
| [00-principles.md](00-principles.md) | 현재 기술·저장·코드 작성 원칙의 원본 | 확정 |
| [01-requirements.md](01-requirements.md) | 사용자, 문제, MVP 범위, 수용 기준 | 구현 기준 |
| [02-architecture.md](02-architecture.md) | 구성 요소, MCP 계약, 데이터, 검증 전략 | 구현 기준 |
...
| [09-implementation.md](09-implementation.md) | 실제 실행 기본값·코드 책임·검증 연결 | 구현됨 |
...
- 변경 시 영향받는 현재 문서와 검증 기준을 갱신하고 `../changes/NNNN-topic.md`에 차이·이유·영향을 기록합니다.
