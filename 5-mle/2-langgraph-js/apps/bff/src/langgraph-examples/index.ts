...
export { graph as l01ReflectionGraph, lectureReflectionGraph } from "./graph-lectures/01-reflection-graph.js";
export {
  graph as advanced04GracefulDegradation,
  graphRetry as advanced04GracefulDegradationRetry,
  graphTryExcept as advanced04GracefulDegradationTryExcept,
  graphFallback as advanced04GracefulDegradationFallback,
  graphPartial as advanced04GracefulDegradationPartial
} from "./graph-advanced/04-graceful-degradation/graph.js";
export { graph as advanced08EvalHarness, evalHarnessGraph } from "./graph-advanced/08-eval-harness/graph.js";
export { graph as advanced09Observability, observabilityGraph } from "./graph-advanced/09-observability/graph.js";
...
export const graphRegistry = {
  ...
  l_01_reflection_graph: () => import("./graph-lectures/01-reflection-graph.js").then((module) => module.graph),
  advanced_04_graceful_degradation: () =>
    import("./graph-advanced/04-graceful-degradation/graph.js").then((module) => module.graph),
  advanced_04_graceful_degradation_retry: () =>
    import("./graph-advanced/04-graceful-degradation/graph.js").then((module) => module.graphRetry),
  advanced_04_graceful_degradation_try_except: () =>
    import("./graph-advanced/04-graceful-degradation/graph.js").then((module) => module.graphTryExcept),
  advanced_04_graceful_degradation_fallback: () =>
    import("./graph-advanced/04-graceful-degradation/graph.js").then((module) => module.graphFallback),
  advanced_04_graceful_degradation_partial: () =>
    import("./graph-advanced/04-graceful-degradation/graph.js").then((module) => module.graphPartial),
  advanced_08_eval_harness: () => import("./graph-advanced/08-eval-harness/graph.js").then((module) => module.graph),
  advanced_09_observability: () => import("./graph-advanced/09-observability/graph.js").then((module) => module.graph)
} as const;
