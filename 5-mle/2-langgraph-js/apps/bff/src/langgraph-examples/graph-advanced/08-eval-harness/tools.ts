...
export const lookupInfo = tool(
  ({ topic }) => {
    const knowledge: Record<string, string> = {
      ...
      bedrock:
        "Amazon Bedrock is a managed service offering foundation models via single API.",
      fastapi:
        "FastAPI is a modern Python web framework based on type hints with async support."
    };
