"""
Example 29 — Static parallel branches.

30 의 `Send` 는 **런타임에 결정되는** 동적 fan-out 이지만, 여기서는
...
선행 예제
---------
- 03: reducer로 병렬 update를 병합하는 방법
- 01: 기본 node/edge 그래프

새 개념
-------
- 하나의 source에서 여러 edge를 추가한 정적 parallel fan-out
- 병렬 branch가 끝날 때까지 기다리는 join barrier

복습 개념
-------
- `Annotated[..., reducer]`를 사용한 병렬 state update 병합
